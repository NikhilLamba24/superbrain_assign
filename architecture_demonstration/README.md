...
Interactive diagrams for the StorySync collaborative AI storyboard.

## How to view these diagrams interactively

GitHub renders Mermaid natively in Markdown, but its embedded render is **static**.
To zoom in / zoom out, pan, and explore each diagram interactively:

1. Open the corresponding `.mmd` file in this folder (e.g. `01_system_architecture.mmd`).
2. Copy its contents.
3. Paste into the [Mermaid Live Editor](https://mermaid.live/).
4. Use the zoom / pan controls (mouse wheel, drag) and export to SVG/PNG as needed.

---

## 1. System Architecture

How the two browsers, the Vercel-hosted frontend and backend, Together AI, and
Supabase fit together — including the realtime update loop back to both clients.
...
The complete two-browser loop: username collision check, heartbeat, image
generation, persistence, and realtime delivery.
...
## 3. Project Ownership & Consent-Based Deletion

The admin-creator flow, co-contributor consent popup (red cross / green tick),
and how a project is (or is not) deleted.
...
All eight tables and their relationships — sessions, versions, contributors,
and the consent-deletion request/response pair.
